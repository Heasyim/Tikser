...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/pembayaranPage.css">
  ...
  <section class="SecNavbar">
    ...
    <section class="confirm">
      ...
      <div class="konfirmasi">
        <img src="Assets/pembayaran.png" alt="">
      </div>
      ...
      <div class="bank">
        <div class="kiri">
          <h2><b>Pilih Bank</b></h2>
        </div>

        <div class="pilih">
          <div class="circle"><p style="color: transparent">a</p></div>
          <div class="circle"><p style="color: transparent">a</p></div>
        ...
        <div class="nama">
          <p class="BCA">Bank BCA</p>
          <p class="Mandiri">Bank Mandiri</p>
        </div>
      </div>
      
      <div class="total">
        <div class="ket">
          <h4><p>Jumlah Tiket:</p></h4>
          <h4><p>Harga Tiket:</p></h4>
          <h4><p>Total Pembayaran:</p></h4>
        </div>
      ...
      <div class="tombol">
          <button><b>Buat Pesanan</b></button>
      </div>
