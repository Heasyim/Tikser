...
<body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto p-2">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="myTiket.php">MY TICKET</a>
                        </li>
                        <li class="nav-item">
    ...
    <section class="SecMyTiket">
        <div class="Identitas">
            <?php
            if (isset($_SESSION['login'])) {
                ?>
                <div class="gambar">
                    <img src="https://osean.uma.pt/wp-content/uploads/2022/04/no-photo.jpg" alt="PotoProfile"
            ...
            if (isset($artistName)) {
                ?>
                <div>
                    <h1 style="color: white; text-align: center; margin-bottom: 25px;">MY TICKET</h1>
                    ...
                    <div class="bodyTabel">
                        <ul style="color: white;">
                            <li>1</li>
                            <li class="row-1">
                                <div class="gambar d-flex" style="margin right: 5px;">
                                    <img src="<?php echo $tampilKonser['image']; ?>" alt="PotoProfile"
                                        style=" width: 165px; height: 165px;">
                                    <h1>
                            ...
                            <li class="row-4">
                                <h3>BELUM BAYAR</h3>
                                <a class="btn btn-warning" href="konfirmasiPage.php?name=<?php echo $tampilArtis['nama']; ?>"
                                    role="button">LANJUT PEMBAYARAN</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <footer class="Footer">
            <div class="Container1">
                <div class="Satu">
                    <ul>
                        <li>
                            <img src="Assets/logo-tikser.svg" class="img-fluid" width="150px" height="60.15px"
                                alt="logo">
                        </li>
                        <li class="WA">
                            <p>WhatsApp</p>
                ...
                <div class="Empat">
                    <ul>
                        ...
                        <li>
                            <img src="Assets/GooglePlay.svg" class="img-fluid" width="150px" height="60.15px"
                                alt="logo">
                        </li>
                        <li>
