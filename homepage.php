      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          ...
          <div class="carousel-caption d-none d-md-block ">
            <a href="selectTiket.php?name=Coldplay"><button type="button" class="btn btn-warning btn-outline-dark">BUY
                TICKET</button></a>
          </div>
        </div>
        <div class="carousel-item">
          ...
          <div class="carousel-caption d-none d-md-block">
            <a href="selectTiket.php?name=Radwimps"><button type="button" class="btn btn-warning btn-outline-dark">BUY
                TICKET</button></a>
          </div>
        </div>
        <div class="carousel-item">
          ...
          <div class="carousel-caption d-none d-md-block">
            <a href="selectTiket.php?name=The Weeknd"><button type="button" class="btn btn-warning btn-outline-dark">BUY
                TICKET</button></a>
          </div>
        </div>
        <div class="event">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          ...
          <div class="carousel-caption">
            ...
            <p>Jakarta - The fans felt joy after it was confirmed that Coldplay would be holding their concert in
              Jakarta.
        ...
        <div class="carousel-item">
          ...
          <div class="carousel-caption d-none d-md-block">
            ...
            <p>We The Fest (WTF) 2023 Announces Exciting Lineup: The Strokes, The 1975, Lewis Capaldi, and More to
              Headline! Get Ready for the Hottest Music Festival in Jakarta this Summer.......</p>
            <a href="#">Baca Selengkapnya</a>
          </div>
        </div>
      </div>
      <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleCaptionsNews"
        data-bs-slide="prev">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <span class="visually-hidden">Previous</span>
      </button>
      <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleCaptionsNews"
        data-bs-slide="next">
        <span class="carousel-control-next-icon" aria-hidden="true"></span>
        <span class="visually-hidden">Next</span>
      </button>
